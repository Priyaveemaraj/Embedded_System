...
int main(void)
{
  ...
  while (1)
  {
	  uint16_t channel[16] = {992,992,992,992,992,992,992,992,992,172,172,172,172,172,172,172};
	  updateSbusPacket(channel, 16);
	  HAL_UART_Transmit_DMA(&huart2, sbusPacket, 25);
	  HAL_Delay(2000);
